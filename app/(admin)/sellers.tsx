              ...
              filteredSellers.map((seller) => {
                const completionRate =
                  seller.settlement_months_count > 0
                    ? (seller.completed_months_count / seller.settlement_months_count) * 100
                    : 0;
                  ...
                  >
                    ...
                    <View style={styles.metricsGrid}>
                      <View style={styles.metricItem}>
                        <Text style={styles.metricValue}>{seller.total_match_count}</Text>
                      ...
                      <View style={styles.paymentRow}>
                        ...
                        <Text
                          style={[
                            ...
                            {
                              color:
                                seller.total_unpaid_amount > 0 ? '#dc2626' : '#9ca3af',
                            },
                          ]}
                        >
                    ...
                    <View style={styles.progressSection}>
                      <View style={styles.progressHeader}>
                        ...
                        <Text style={styles.progressValue}>
                          {seller.completed_months_count}/{seller.settlement_months_count}개월
